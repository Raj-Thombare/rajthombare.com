...
const Header = () => {
  return (
    <header className="w-[100%] min-h-screen md:min-h-full  pt-[50px] pb-10 px-10 text-center md:text-left flex justify-end md:justify-between flex-col-reverse md:flex-row items-center md:items-start">
